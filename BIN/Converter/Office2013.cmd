chcp 65001 >nul
@echo off
Title CONVERT OFFICE 2013 - Copyright (C) HungVN by TDZ Group. All rights reserved.
...
set "ver= 2013"
cd /d %~dp0\"License Files\License13\"
@echo.
@echo ===========================
Choice /N /C 1234567 /M "* Nhap lua chon cua ban :
IF %errorlevel% == 1 SET "EDITION=ProjectPro" & GOTO 2Volume2013 
IF %errorlevel% == 2 SET "EDITION=ProPlusVL" & GOTO 2Volume2013 
IF %errorlevel% == 3 SET "EDITION=VisioProVL" & GOTO 2Volume2013 
IF %errorlevel% == 4 SET "EDITION=ProjectPro" & GOTO 2Retai2013 
IF %errorlevel% == 5 SET "EDITION=ProPlus" & GOTO 2Retai2013 
IF %errorlevel% == 6 SET "EDITION=VisioPro" & GOTO 2Retai2013
...
cd /d %~dp0\"License Files\License13\Volume"
...
FOR %%G IN (client*.xrm-ms) DO (cscript //Nologo %folder%\ospp.vbs /inslic:%%G)
FOR %%G IN (pkeyconfig*.xrm-ms) DO (cscript //Nologo %folder%\ospp.vbs /inslic:%%G)
cd /d %~dp0\"License Files\License13\Retail"
FOR %%G IN (%EDITION%*.xrm-ms) DO (cscript //Nologo %folder%\ospp.vbs /inslic:%%G)
echo.&echo COMPLETED !
echo.
pause
