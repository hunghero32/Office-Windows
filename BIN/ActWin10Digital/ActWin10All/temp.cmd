...
%ELine%
echo Da phat hien phien ban OS khong duoc ho tro.
echo Script chi ho tro cho Windows 10.
goto DL_Done
)
...
echo:
call :DL_color1 "     " %Black% &call :DL_color "Kiem tra: %winos% duoc Kich hoat VINH VIEN." %Green%
call :DL_color1 "     " %Black% &call :DL_color "Ban khong can Kich hoat nua." %Gray%
echo ___________________________________________________________________________________________
echo:
...
if defined Eval (
%ELine%
echo [%winos% ^| %winbuild%] khong ho tro Kich hoat Ban Quyen So.
...
if "%osedition%"=="" (
%ELine%
echo [%winos% ^| %winbuild% ^| SKU:%osSKU%] khong ho tro Kich hoat Ban Quyen So.
goto DL_Done
)
...
set "Chkint=Kiem tra Ket noi Internet              "
set IntCon=
...
if defined PermAct (
call :DL_color "%winos% duoc Kich hoat VINH VIEN." %Green%
goto :DL_Act_Cont
)

call :DL_color "Kich hoat loi %Error_Code_%" %Red%
call :DL_color "Thu lai voi Tip Fix loi va doc ky Huong dan su dung." %Magenta%
